// based upon https://github.com/argyleink/gui-challenges/tree/main/spring-physics from Adam Argyle
// in GUI challenges with Adam Argyle at https://www.youtube.com/watch?v=eamAHF71ZN4&t=37s
...
export default class SpringPhysics {
  ...
  to(targetValue) {
    this.start = this.tickValue || this.tickValue === 0 ? this.tickValue : this.start
